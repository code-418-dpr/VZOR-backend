...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VZOR.Accounts.Domain.AdminProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("VZOR.Accounts.Domain.ParticipantAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("VZOR.Accounts.Domain.RefreshSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("VZOR.Accounts.Domain.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("VZOR.Accounts.Domain.RolePermission", b =>
                {
                    b.Property<Guid>("RoleId")
                        .HasColumnType("uuid")
                        .HasColumnName("role_id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("VZOR.Accounts.Domain.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VZOR.Accounts.Domain.AdminProfile", b =>
                {
                    b.HasOne("VZOR.Accounts.Domain.User", "User")
                        .WithOne()
            ...
            modelBuilder.Entity("VZOR.Accounts.Domain.ParticipantAccount", b =>
                {
                    b.HasOne("VZOR.Accounts.Domain.User", "User")
                        ...
                        .HasForeignKey("VZOR.Accounts.Domain.ParticipantAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("VZOR.Accounts.Domain.RolePermission", b =>
                {
                    b.HasOne("VZOR.Accounts.Domain.Permission", "Permission")
                    ...
                    b.HasOne("VZOR.Accounts.Domain.Role", "Role")
                        .WithMany("RolePermissions")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
